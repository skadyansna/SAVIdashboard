...
function barstacker(data) {
    ...
    settings4.textPx = 30;
    settings4.maxValue = 10;
    settings4.color = "#0066FF";
    settings4.cornerRoundingX = 5;
    settings4.cornerRoundingY = 5;
    var cpu_value =Math.round((data.instance).split('instance')[0]);
    if(!stacker4) {
    ...
    settings5.maxValue = 50;
    settings5.valuePostfix = "GB";
    settings5.color = "#FFFFFF";
    var memory_value =Math.round(data.memory.split("MB")[0]/1000);
    if(!stacker5){
